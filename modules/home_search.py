...
def search_home_directory():
    ...
    try:
        ...
        for user_folder in os.listdir(home_dir):
            ...
            flag_search = search_for_flags(user_path, results)
            
            # Search for .ssh folder
            ssh_search = search_for_ssh(user_path, user_folder, results)
...
def search_for_flags(base_path, results):
    """
...
def search_for_ssh(user_path, user_folder, results):
    """
...
def main_entry():
    findings = search_home_directory()
